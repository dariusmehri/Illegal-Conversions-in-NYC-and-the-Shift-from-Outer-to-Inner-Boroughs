...
The data for this project were the DOB ECB violations filtered for hazardous illegal conversions and sourced from NYC Open Data and analyzed using a combination of Python, Power BI, and generative AI to clean, model, and visualize insights.
